...
const COLUMNS_KEY = 'agentmanager-active-terminals-cols';
const ROWS_KEY = 'agentmanager-active-terminals-rows';
const MINIMIZED_KEY = 'agentmanager-active-terminals-minimized';
